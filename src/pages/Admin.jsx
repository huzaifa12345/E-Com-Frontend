  ...
  const handleSaveProduct = async () => {
    try {
      ...
      const productData = {
        ...
        image_url:
          uploadedImages.length > 0 ? uploadedImages[0] : productForm.image_url,
      ...
      <div className="col-12">
        <div className="card">
          ...
          >
            ...
            <div className="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center w-100 mt-3 mt-sm-0">
              <div className="input-group me-sm-3 mb-2 mb-sm-0" style={{ width: "100%",  }}>
                <input
                  type="text"
                    ...
                    filteredProducts.map((product) => (
                      <tr key={product.id}>
                        ...
                        <td className="text-center">
                          {product.category_relation?.name || "N/A"}
                        </td>
                        ...
                        <td className="text-center text-white">
                          <span
                            className={`badge ${product.is_active ? "bg-success" : "bg-secondary"}`}
                          >
          ...
          <>
            ...
            >
              <div
                ...
                style={{ margin: "auto", maxHeight: "95vh" }}
              >
                <div
                  ...
                  <div className="modal-body">
                    <div className="row">
                      ...
                      <div className="col-md-6 mb-3">
                        ...
                        <small className="text-muted">
                          {editingProduct
                            ? "Existing SKU cannot be changed"
                            : `Next SKU: ${nextSku}`}
                        </small>
                      </div>
                          ...
                          {(() => {
                            ...
                            return level3Categories
                              .map((category) => {
                                ...
                                const season = categories.find(
                                  (cat) => cat.id === gender.parent_id,
                                );
                      ...
                      <div className="col-md-6">
                        ...
                        <p>
                          ...
                          {selectedOrder.payment_method
                            ?.charAt(0)
                            .toUpperCase() +
                            selectedOrder.payment_method?.slice(1) || "N/A"}
                        </p>
                      </div>
                    </div>
